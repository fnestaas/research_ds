"""
First test, taken and adapted from https://docs.kidger.site/diffrax/examples/neural_ode/

Here, there is some focus on the ODE2ODE Func's taken from "An Ode to an ODE" https://arxiv.org/pdf/2006.11421.pdf
However, we moved away from these as the project progressed and they are less relevant. 
"""
